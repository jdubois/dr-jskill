...
- **Azure** — see [`references/AZURE.md`](../references/AZURE.md). Azure CLI deployment to Azure Container Apps with an optional VNET-injected Azure Database for PostgreSQL Flexible Server. Uses managed identity for ACR pulls and Azure Key Vault for the DB password.
